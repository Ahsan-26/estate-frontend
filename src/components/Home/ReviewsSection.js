...
const reviews = [
  { name: "Urvashi", username: "@Urvashi49", text: "I appreciated their 'No-Spam' promise. EstateOne never bombarded me with calls or emails but was always available when I needed them. A refreshing experience in this industry!", image: "/images/Urvashi.jpg" },
  ...
  { name: "Renu", username: "@renu077", text: "The best real estate service I’ve ever used! No pressure, no stress—just clear and professional advice.", image: "/images/Renu.jpg" },
  { name: "Samayak", username: "@smayak01_", text: "EstateOne’s customer service was beyond my expectations. They truly care about their clients and provide outstanding support!", image: "/images/Samayak.jpg" },
  { name: "Naman", username: "@Naman421", text: "A reliable real estate service with genuine professionals. EstateOne ensured I got the best deal for my property.", image: "/images/Naman.jpg" },
  { name: "Dikhsha Nagpal", username: "@DK69p", text: "I would highly recommend EstateOne! They took care of everything from property search to final paperwork, making the process stress-free.", image: "/images/Dikhsa.jpg" },
  { name: "Nitish", username: "@N1t1SH", text: "Exceptional service with complete transparency. The team at EstateOne made the home-buying process enjoyable and simple.", image: "/images/Nitish.jpg" },
  { name: "Sachin Tripathi", username: "@Sachin690", text: "Professional, responsive, and highly knowledgeable. EstateOne is my go-to for all real estate needs.", image: "/images/Sachin.jpg" },
  { name: "Megha Kwatra", username: "@Megha23", text: "I had an amazing experience with EstateOne. They made property investment so much easier!", image: "/images/Megha.jpg" },
  { name: "Karan Kapoor", username: "@KK-e665", text: "Best decision ever! EstateOne provided fantastic guidance and ensured everything was smooth.", image: "/images/karan.jpg" },
